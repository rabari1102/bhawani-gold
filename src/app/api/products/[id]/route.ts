  ...
  try {
    ...
    const product = await prisma.product.update({
      ...
      data: {
        ...
        ...(data.isHallmarked !== undefined && {
          isHallmarked: data.isHallmarked,
        }),
        ...(data.price !== undefined && {
          price: data.price ? parseFloat(data.price) : null,
        }),
        ...(data.isTopTrending !== undefined && {
          isTopTrending: data.isTopTrending,
        }),
        ...(data.isNewArrival !== undefined && {
          isNewArrival: data.isNewArrival,
        }),
        ...(data.isSpecialSelection !== undefined && {
          isSpecialSelection: data.isSpecialSelection,
        }),
